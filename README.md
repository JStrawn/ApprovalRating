...
#How To Use APRVD
To use APRVD for yourself, simply clone the project. Before it will work, you have to get an API from WebHose.io. It's free as long as you don't go over 1000 requests per month, and APRVD makes 4 requests per search.
